      ...
      <div className="container mx-auto flex items-center justify-between px-6">
        ...
        <div className="hidden md:flex items-center w-1/3 relative">
          <input
            type="text"
            placeholder="Search..."
            className="w-full py-2 px-4 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <FiSearch
        ...
        <div className="hidden md:flex space-x-6">
          {["Home", "About", "Investments", "Subsidiaries", "Contact"].map(
            (link) => (
              <Link
                key={link}
                to={`/${link.toLowerCase()}`}
